...
//  Trivia
//
//  Created by Wilkins, Nolan W on 2/23/23.
//
...
struct Trivia
{
    ...
    func isCorrectAnswer(_ s : String) -> Bool{
        return s == self.correct_answer
    }
    
    func getScrambledAnswers() -> [String]{
        var answers = Array(self.incorrect_answers)
